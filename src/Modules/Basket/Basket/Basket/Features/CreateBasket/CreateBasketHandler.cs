namespace Basket.Basket.Features.CreateBasket
{
    ...
    public class CreateBasketCommadValidator : AbstractValidator<CreateBasketCommand>
    {
        public CreateBasketCommadValidator()
        {
                ...
                : ICommandHandler<CreateBasketCommand, CreateBasketResult>
        {
            ...
            {
                var newShoppingCart = CreateNewBasket(command.ShoppingCart);

                await repository.CreateBasket(newShoppingCart, cancellationToken);
